...
RIME operates at three stages of the ML lifecycle.
...
## Key Features
RIME addresses these risks with four core products:
...
We offer three variations of RI Platform tailored to different deployment patterns. [More information on deployment patterns can be found here.](/for_admins/installation_guide.rst)

|                          | Self-Hosted                 | Managed Cloud         | Cloud (Beta)                                                                      |
|--------------------------|-----------------------------|-----------------------|-----------------------------------------------------------------------------------|
...
For trial evaluations, a lightweight local installation is also supported (see [Local Trial](/local_trial/index.rst)).

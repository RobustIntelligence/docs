...
* To set up SSO, an Admin simply needs to navigate to SSO Configuration page under Organization settings. 
* To configure SSO, you will need to provide the Client ID, Client Secret, and Issuer URL.

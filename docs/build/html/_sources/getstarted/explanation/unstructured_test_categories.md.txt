...
Test for the presence of potentially corrupted samples in your data.        <br>        <br>        Labels are required.        <br>        <br>        Note that the default behavior of this test in Continuous Testing depends        on the quality of data used for the initial stress test. If corrupted samples        were detected in the stress test, then the continuous test will be more         permissive.
